...
def fetch_poster(movie_id):
    url = "https://api.themoviedb.org/3/movie/{}?api_key=d0952f5607f255032a41193d061b5e86&&language=en-US".format(movie_id)
...
st.markdown(
    ...
    <style>
        ...
        .stText {
            color: white; /* White text for all text elements */
        }
    </style>
    """,
